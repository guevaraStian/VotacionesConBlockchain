...
def home():
    ...
    # Crear gráfico en diferentes tipos de grafica
    fig = px.bar(df_votos, x='Nombre', y='Votos', title='Resultados de Votación')
    #figl = px.line(df_votos, x='Nombre', y='Votos', title='Resultados de Votación')
    #figp = px.pie(df_votos, x='Nombre', y='Votos', title='Resultados de Votación')

    dash_app.layout = html.Div([
        html.H1("Grafica barras", style={"textAlign": "center"}),
